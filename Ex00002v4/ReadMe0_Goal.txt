...
Sanity 
    ...
    curl -i -X POST http://localhost:3000/api/songs -H "Content-Type: application/json" -d "{\"title\":\"title 8\", \"artistId\": \"88939d74-dffd-11f0-87a2-0afd50b0f46d\"}" 

    Update song (eg single field) 
    curl -i -X PATCH http://localhost:3000/api/songs/39606de9-131e-4fcb-955d-c9a942fa46ea -H "Content-Type: application/json" -d "{\"title\":\"Updated 0101\"}"
